...
BitcoinNew now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<bitcoinnew_address\> \<monthly_payment_bitcoinnew\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<bitcoinnew_address\> \<monthly_payment_bitcoinnew\> \<collateral_hash\>
 ...
 * vote-many          - Vote on a BitcoinNew initiative
 * vote-alias         - Vote on a BitcoinNew initiative
 * vote               - Vote on a BitcoinNew initiative/budget
