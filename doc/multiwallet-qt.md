...
In order to support loading of multiple wallets in bitcoinnew-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinnew.cpp.
...
Changes to bitcoinnew.cpp
----------------------
bitcoinnew.cpp is the entry point into bitcoinnew-qt, and as such, will require some minor modifications to provide hooks for
