...
Intro
-----
BitcoinNew (BTCN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. BitcoinNew utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run bitcoinnew-qt.exe.

BitcoinNew Core is the original BitcoinNew client and it builds the backbone of the network.
However, it downloads and stores the entire history of BitcoinNew transactions;
