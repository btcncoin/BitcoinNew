...
This mechanism has been integrated into Bitcore-Node-BitcoinNew which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoinnew/insight-api-bitcoinnew#web-socket-api](https://github.com/bitcoinnew/insight-api-bitcoinnew#web-socket-api)
* API: [https://github.com/bitcoinnew/insight-api-bitcoinnew#swifttx-transactions](https://github.com/bitcoinnew/insight-api-bitcoinnew#swifttx-transactions)
...
By default, the BitcoinNew Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitcoinNew Core daemon:
