...
#   c) node1 mines 32 blocks, so now node 0 has 500000BTCN, node 1 has 4250BTCN, node2 has none.
#   d) node0 sends 601 BTCN to node2, in two transactions (301 BTCN, then 300 BTCN).
