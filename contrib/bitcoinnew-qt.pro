...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bitcoinnew-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/bitcoinnew-cli.cpp \
           src/bitcoinnew-tx.cpp \
           src/bitcoinnew.cpp \
           src/db.cpp \
           ...
           src/qt/bitcoinnew.cpp \
           src/qt/bitcoinnewstrings.cpp \
...
RESOURCES += src/qt/bitcoinnew.qrc src/qt/bitcoinnew_locale.qrc

TRANSLATIONS += src/qt/locale/bitcoinnew_bg.ts \
                src/qt/locale/bitcoinnew_de.ts \
                src/qt/locale/bitcoinnew_en.ts \
                src/qt/locale/bitcoinnew_es.ts \
                src/qt/locale/bitcoinnew_fi.ts \
                src/qt/locale/bitcoinnew_fr.ts \
                src/qt/locale/bitcoinnew_it.ts \
                src/qt/locale/bitcoinnew_ja.ts \
                src/qt/locale/bitcoinnew_pl.ts \
                src/qt/locale/bitcoinnew_pt.ts \
                src/qt/locale/bitcoinnew_ru.ts \
                src/qt/locale/bitcoinnew_sk.ts \
                src/qt/locale/bitcoinnew_sv.ts \
                src/qt/locale/bitcoinnew_vi.ts \
                src/qt/locale/bitcoinnew_zh_CN.ts \
                src/qt/locale/bitcoinnew_zh_TW.ts
