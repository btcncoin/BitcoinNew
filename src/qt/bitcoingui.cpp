...
// Copyright (c) 2017-2018 The BitcoinNew Coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitcoinNew Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinnew: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitcoinNew Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinNew Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for BitcoinNew Core"));
    ...
    openAction->setStatusTip(tr("Open a bitcoinnew: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitcoinNew Coin help message to get a list with possible BitcoinNew Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        labelLogo->setPixmap(QIcon(":/images/bitcoinnew_logo_horizontal").pixmap(210, 50));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitcoinNew Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinNew network", "", count));
}
...
{
    QString strTitle = tr("BitcoinNew Core"); // default title
    ...
    // Append title to "BitcoinNew Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
