...
{
    // return if URI is not valid or is no bitcoinnew: URI
...
{
    // Convert bitcoinnew:// to bitcoinnew:
    //
    //    Cannot handle this later, because bitcoinnew:// will cause Qt to see the part after // as host,
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "BitcoinNew.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for BitcoinNew.lnk
...
{
    return GetAutostartDir() / "bitcoinnew.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a bitcoinnew.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=BitcoinNew\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the bitcoinnew app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add bitcoinnew app to startup item list
