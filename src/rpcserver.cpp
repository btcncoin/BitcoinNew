...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitcoinNew features */
        {"bitcoinnew", "masternode", &masternode, true, true, false},
        {"bitcoinnew", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinnew", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinnew", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinnew", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinnew", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinnew", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinnew", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinnew", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinnew", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinnew", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinnew", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinnew", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinnew", "mnbudget", &mnbudget, true, true, false},
        {"bitcoinnew", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinnew", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinnew", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinnew", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinnew", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinnew", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinnew", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinnew", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinnew", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinnew", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinnew", "mnsync", &mnsync, true, true, false},
        {"bitcoinnew", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> bitcoinnew-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8586/\n";
}
