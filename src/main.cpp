...
#if defined(NDEBUG)
#error "BitcoinNew cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uBTCN) are considered zero fee (for relaying and mining)
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    ret = blockValue * 0.85; // 80% of block reward
...
{
    RenameThread("bitcoinnew-scriptch");
