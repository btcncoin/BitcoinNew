...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitcoinNew Core bitcoinnew-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinnew-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinnew transaction") + "\n" +
                               "  bitcoinnew-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinnew transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinnew transaction
