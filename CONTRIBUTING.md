Contributing to BitcoinNew Core
==================================

The BitcoinNew Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitcoinNew Core project, and is not to be
confused with overall BitcoinNew Network Protocol consensus changes.

Whether a pull request is merged into BitcoinNew Core rests with the project merge
...
Patches that change BitcoinNew consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitcoinNew consensus, it must have been
...
The project leader is the release manager for each BitcoinNew Core release.
